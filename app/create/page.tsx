 ...
 const handleSubmit = async () => {
    try {
      const postData = {
        ...
        // Make sure we're sending just the ID strings
        handwriting: typeof formData.handwriting === 'string' ? formData.handwriting : formData.handwriting?._id,
        card: typeof formData.card === 'string' ? formData.card : formData.card?._id,
 ...
 return (
   <main className="min-h-screen bg-white pb-32">
     <div className="pt-10">
       ...
       {currentStep === 3 && (
         <HandwritingStep
           initialData={formData.handwriting}
           updateData={(data) => updateFormSection('handwriting', data)}
